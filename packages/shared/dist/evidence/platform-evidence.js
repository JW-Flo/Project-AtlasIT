 ...
 */
export const AUDIT_EVIDENCE_REGISTRY = [
    // ── Access Management ───────────────────────────────────────────────
    {
...
const AUDIT_EVIDENCE_INDEX = new Map();
for (const m of AUDIT_EVIDENCE_REGISTRY) {
    AUDIT_EVIDENCE_INDEX.set(m.action, m);
}
export function lookupAuditEvidence(action) {
 ...
 */
export const PLATFORM_STATE_PROBES = [
    {
...
//# sourceMappingURL=platform-evidence.js.map