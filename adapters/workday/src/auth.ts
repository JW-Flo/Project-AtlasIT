...
const AUTHORIZATION_URL = "https://{tenant}.workday.com/authorize";
const TOKEN_URL = "https://{tenant}.workday.com/oauth2/{tenant}/token";
const SCOPES = ["Human_Resources", "Staffing"];
