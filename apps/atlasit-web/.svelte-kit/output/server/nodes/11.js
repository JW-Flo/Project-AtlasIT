import * as universal from "../entries/pages/security/incidents/_page.ts.js";

export const index = 11;
let component_cache;
export const component = async () =>
  (component_cache ??= (
    await import("../entries/pages/security/incidents/_page.svelte.js")
  ).default);
export { universal };
export const universal_id = "src/routes/security/incidents/+page.ts";
...
export const stylesheets = ["_app/immutable/assets/11.BleGF1KY.css"];
export const fonts = [];
