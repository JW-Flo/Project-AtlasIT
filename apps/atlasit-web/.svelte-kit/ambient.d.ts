...
declare module "$env/static/private" {
  ...
  export const KV_NAMESPACE: string;
  export const npm_config_local_prefix: string;
  export const USER: string;
  export const OKTA_DOMAIN: string;
  export const COMMAND_MODE: string;
  export const npm_config_globalconfig: string;
  export const CF_ACCOUNT_ID: string;
  export const DO_BINDING: string;
  export const SSH_AUTH_SOCK: string;
  export const __CF_USER_TEXT_ENCODING: string;
  export const CF_API_EMAIL: string;
  export const D1_DATABASE: string;
  export const VSCODE_PROFILE_INITIALIZED: string;
  export const OKTA_API_TOKEN: string;
  export const npm_execpath: string;
  export const PYDEVD_DISABLE_FILE_VALIDATION: string;
  export const PATH: string;
  export const ORCHESTRATOR_API_KEY: string;
  ...
  export const FEATURE_IDP_OKTA: string;
  export const GIT_USER: string;
  export const ONBOARDING_API_KEY: string;
  export const VSCODE_GIT_ASKPASS_MAIN: string;
  export const PYTHON_BASIC_REPL: string;
  export const npm_config_loglevel: string;
  export const HOMEBREW_PREFIX: string;
  export const WRANGLER_PROJECT: string;
