  ...
  return c.html(`
    ...
    <body class="bg-gray-900 text-white ios-safe">
      ...
      <script>
        ...
        const CLIENT_ID = 'mcp-mobile';
        const CLIENT_SECRET = '${process.env.MCP_MOBILE_SECRET}';
        const IDP_URL = 'https://idp.project-ignite.kd8jc7v8cd.workers.dev';
