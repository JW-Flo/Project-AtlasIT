...
const opts = {
  ...
  options: {
    ...
    'sonar.sources': '.',
    'sonar.exclusions': '**/node_modules/**,**/dist/**,**/.svelte-kit/**,**/vendor/**,**/tests/**,**/coverage/**,**/*.spec.ts,**/*.test.ts,**/*.test.js,**/docs/cloudflare/**',
...
scanner(opts, () => { console.log('Sonar scan complete'); });
