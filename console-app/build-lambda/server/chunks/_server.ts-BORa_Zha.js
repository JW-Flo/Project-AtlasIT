...
const POST = async ({ request, platform, locals }) => {
  ...
  try {
    const res = await coreFetch(env, "/api/v1/apps/lifecycle/workflows", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    return new Response(JSON.stringify({ error: "Lifecycle workflows service unavailable" }), {
      status: 503,
      headers: { "Content-Type": "application/json" }
    });
  }
...
export { POST };
//# sourceMappingURL=_server.ts-BORa_Zha.js.map
