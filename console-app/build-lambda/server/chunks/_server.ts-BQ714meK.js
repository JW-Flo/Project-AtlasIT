import { g as getCredentials, b as getOAuthAccessToken, u as updateTestStatus } from './credentials-CkBYNzQv.js';
...
${await sha256Hex(canonicalRequest)}`;
  ...
  github: async (creds, token) => {
    const tok = token || creds.personal_access_token || creds.pat || creds.client_secret || creds.api_key;
    if (!tok)
      return {
        ok: false,
...
async function genericTest(creds) {
...
export { POST };
//# sourceMappingURL=_server.ts-BQ714meK.js.map
