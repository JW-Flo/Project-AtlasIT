const integrations = [
  // Productivity
  {
    ...
    auth: "platform_oauth",
    tier: "core",
    description: "Automate user provisioning, group membership, and suspension via Admin SDK.",
    credentialFields: []
  },
  {
    id: "microsoft_365",
  ...
  },
  {
    ...
    auth: "platform_oauth",
    tier: "core",
    description: "Provision and deprovision Slack users via SCIM. Requires Business+ or Enterprise Grid.",
    credentialFields: []
  },
  {
    id: "jira",
    ...
    auth: "platform_oauth",
    tier: "core",
    description: "Manage Atlassian Cloud users and project access via SCIM and REST API.",
    credentialFields: []
  },
  {
    id: "confluence",
    ...
    auth: "platform_oauth",
    tier: "core",
    description: "Manage Confluence Cloud space permissions and user access via Atlassian Admin API.",
    credentialFields: []
  },
  // HR
  {
    ...
    auth: "api_key",
    tier: "extended",
    description: "Sync employee records and detect new hires, role changes, and terminations.",
    credentialFields: [
      {
        key: "api_key",
        label: "API Key",
  ...
  },
  {
    ...
    auth: "tenant_oauth",
    tier: "extended",
    description: "Connect to Workday HCM for worker lifecycle events and org structure.",
    credentialFields: [
      {
        key: "tenant_url",
        label: "Tenant URL",
  ...
  },
  {
    ...
    auth: "api_key",
    tier: "extended",
    description: "Sync worker hire, terminate, and rehire events via ADP APIs with mTLS.",
    credentialFields: [
      {
        key: "ssl_cert",
        ...
        type: "textarea",
        required: true,
        helpText: "Mutual TLS certificate provided by ADP for API authentication"
      },
      {
        key: "ssl_key",
  ...
  },
  {
    ...
    auth: "api_key",
    tier: "core",
    description: "Manage persons on connected accounts for identity verification.",
    credentialFields: [
      {
        key: "secret_key",
        label: "Secret Key",
  ...
  // Security
  {
    ...
    auth: "tenant_oauth",
    tier: "core",
    description: "Full user lifecycle management — create, suspend, deactivate, and group membership.",
    credentialFields: [
      {
        key: "domain",
        label: "Okta Domain",
  ...
  },
  {
    ...
    auth: "tenant_oauth",
    tier: "extended",
    description: "Manage users, roles, and organizations via Auth0 Management API.",
    credentialFields: [
      {
        key: "domain",
        label: "Auth0 Domain",
  ...
  },
  {
    ...
    credentialFields: [
      ...
      },
      {
        ...
        helpText: "US-1: api.crowdstrike.com, US-2: api.us-2.crowdstrike.com, EU-1: api.eu-1.crowdstrike.com"
      }
    ]
  },
  {
    ...
    auth: "api_key",
    tier: "extended",
    description: "Manage 1Password team members, groups, and vault access policies.",
    credentialFields: [
      {
  ...
  },
  {
    ...
    auth: "api_key",
    tier: "extended",
    description: "Manage PagerDuty users and team assignments for incident response.",
    credentialFields: [
      {
        key: "api_key",
        label: "REST API Key",
  ...
  },
  {
    ...
    auth: "tenant_oauth",
    tier: "extended",
    description: "Zero Trust network security platform. Provision users and manage access policies across ZIA and ZPA via ZIdentity.",
    credentialFields: [
      {
        key: "client_id",
        label: "Client ID",
  ...
  },
  {
    ...
    auth: "service_account",
    tier: "extended",
    description: "Manage Cloud Identity users and groups via Admin SDK with domain-wide delegation.",
    credentialFields: [
      {
        key: "client_email",
  ...
  },
  {
    ...
    auth: "platform_oauth",
    tier: "core",
    description: "Manage organization members and team assignments via GitHub REST API.",
    credentialFields: []
  },
  {
    id: "datadog",
    ...
    auth: "api_key",
    tier: "extended",
    description: "Manage Datadog users and role assignments for observability access control.",
    credentialFields: [
      {
        key: "api_key",
        label: "API Key",
  ...
  // Communication
  {
    ...
    auth: "platform_oauth",
    tier: "extended",
    description: "Provision and manage Zoom users, including activation and deactivation.",
    credentialFields: []
  },
  {
    id: "teams",
  ...
  // CRM / Sales
  {
    ...
    auth: "platform_oauth",
    tier: "core",
    description: "Manage Salesforce users and permission sets via REST API and SCIM.",
    credentialFields: []
  },
  {
    id: "hubspot",
  ...
  // Project Management
  {
    ...
    auth: "platform_oauth",
    tier: "extended",
    description: "Manage Asana workspace members and team assignments via REST API.",
    credentialFields: []
  },
  {
    id: "monday",
...
export { iconMap as a, categories as c, integrations as i };
//# sourceMappingURL=integrations-C0eSUhV4.js.map
