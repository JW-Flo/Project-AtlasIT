const ruleTemplates = [
  ...
  },
  {
    ...
    description: "Run leaver workflow across all connected apps when a user is deactivated in the directory",
    category: "lifecycle",
  ...
  },
  {
    ...
    description: "Run joiner workflow to provision all mapped apps when a new user appears in directory sync",
    category: "lifecycle",
  ...
  },
  {
    ...
    description: "Trigger a directory sync whenever a new app is connected to ensure user mappings are current",
    category: "provisioning",
...
export { ruleTemplates as r };
//# sourceMappingURL=templates-CNh06UPP.js.map
