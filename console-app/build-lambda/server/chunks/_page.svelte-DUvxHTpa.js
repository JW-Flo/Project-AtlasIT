...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="space-y-6"><h1 class="text-2xl font-semibold tracking-tight">Billing</h1> <div class="flex gap-1 border-b"><!--[-->`);
    ...
    $$renderer2.push(`<!--]--></div> `);
    {
      ...
      Skeleton($$renderer2, { class: "h-40 w-full" });
      $$renderer2.push(`<!----> `);
      Skeleton($$renderer2, { class: "h-32 w-full" });
      $$renderer2.push(`<!----></div>`);
    }
    $$renderer2.push(`<!--]--></div>`);
...
//# sourceMappingURL=_page.svelte-DUvxHTpa.js.map
