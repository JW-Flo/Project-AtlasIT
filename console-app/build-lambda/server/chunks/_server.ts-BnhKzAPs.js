...
const ATTESTABLE_CONTROLS = {
  ...
  "SOC2-CC1.2": {
    ...
    evidenceGuidance: {
      summary: "Demonstrate that the board or senior leadership actively oversees the information security program.",
  ...
  "SOC2-CC1.3": {
    ...
    evidenceGuidance: {
      summary: "Show that an organizational chart exists, is current, and clearly defines reporting lines for security roles.",
      recommendedDocuments: [
  ...
  "SOC2-CC3.2": {
    ...
    evidenceGuidance: {
      summary: "Demonstrate that third-party vendors with access to sensitive data have been risk-assessed.",
      recommendedDocuments: [
  ...
  "SOC2-CC9.1": {
    ...
    evidenceGuidance: {
      summary: "Provide the current risk register showing all identified risks, their ratings, and mitigation status.",
      recommendedDocuments: [
  ...
  "SOC2-CC9.2": {
    ...
    evidenceGuidance: {
      summary: "Demonstrate that a BC/DR plan exists and has been tested within an acceptable timeframe.",
      recommendedDocuments: [
  ...
  "SOC2-CC7.3": {
    ...
    evidenceGuidance: {
      summary: "Show that an incident response plan exists, is current, and has been tested via drill or tabletop exercise.",
      recommendedDocuments: [
  ...
  "SOC2-CC7.5": {
    ...
    evidenceGuidance: {
      summary: "Demonstrate that a formal breach notification procedure exists covering regulatory and customer notification requirements.",
      recommendedDocuments: [
  ...
  "GDPR-Art.5(1)(a)": {
    ...
    evidenceGuidance: {
      summary: "Document the lawful basis (consent, contract, legitimate interest, etc.) for each category of personal data processing.",
      recommendedDocuments: [
  ...
  "GDPR-Art.5(1)(b)": {
    ...
    evidenceGuidance: {
      summary: "Show that personal data is collected for specified, explicit purposes and not further processed in an incompatible manner.",
      recommendedDocuments: [
  ...
  "GDPR-Art.5(1)(c)": {
    ...
    evidenceGuidance: {
      summary: "Demonstrate that only necessary personal data is collected and retained for each processing purpose.",
      recommendedDocuments: [
  ...
  "GDPR-Art.5(1)(d)": {
    ...
    evidenceGuidance: {
      summary: "Show controls ensuring personal data is accurate, up-to-date, and correctable by data subjects.",
      recommendedDocuments: [
  ...
  "HIPAA-164.312(a)(2)(i)": {
    ...
    evidenceGuidance: {
      summary: "Document the procedure for obtaining emergency access to ePHI when normal access controls are unavailable.",
      recommendedDocuments: [
...
const POST = async ({ locals, platform, request }) => {
  ...
  if (!evidenceSummary || typeof evidenceSummary !== "string" || evidenceSummary.trim().length < 10) {
...
const DELETE = async ({ locals, platform, url }) => {
  ...
  try {
    ...
    ).bind(attestationId, user.tenantId).run();
...
//# sourceMappingURL=_server.ts-BnhKzAPs.js.map
