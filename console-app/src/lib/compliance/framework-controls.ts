...
> = {
  SOC2: [
    ...
    },
    {
      ...
      description:
        "Management establishes structures, reporting lines, and authority to support system objectives",
      automatable: false,
    },
    {
      name: "CC1.3 - Integrity and Ethical Values",
      description:
        "Entity demonstrates commitment to integrity and ethical values through standards of conduct",
      automatable: false,
    },
    {
      name: "CC1.4 - Competence",
      description:
        "Entity obtains or generates, uses, and maintains relevant, quality information for operating effectively",
      automatable: true,
    ...
    },
    {
      ...
      description:
        "The board considers potential for fraud in evaluating risks to objectives",
      automatable: false,
    },
    // CC2: Communication & Information (3)
    {
      ...
      description:
        "Entity communicates responsibility for system design and operation to internal stakeholders",
      automatable: true,
    ...
    },
    {
      ...
      description:
        "Entity communicates with external parties regarding matters affecting system design and operation",
      automatable: false,
    },
    {
      name: "CC2.3 - Information Processing",
      description:
        "Entity obtains and maintains relevant quality information supporting the functioning of internal control",
      automatable: true,
    ...
    },
    {
      ...
      description:
        "Entity considers potential for fraud in assessing risks to the achievement of objectives",
      automatable: false,
    },
    {
      name: "CC3.3 - Monitoring Changes",
      description:
        "Entity considers how changes could impact the system and objectives",
      automatable: true,
    ...
    },
    {
      ...
      description:
        "Entity identifies, analyzes, and responds to changes that could significantly impact system objectives",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    // CC4: Monitoring Activities (2)
    {
      ...
      description:
        "Entity selects, develops, and performs ongoing evaluations of internal control",
      automatable: true,
    ...
    },
    {
      ...
      description:
        "Entity monitors system activities and identifies findings needing corrective action",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    // CC5: Control Activities (3)
    {
      ...
      description:
        "Entity selects and develops control activities that contribute to mitigation of risks",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Entity also considers the potential for management override of controls",
      automatable: false,
    },
    {
      name: "CC5.3 - Authorization Procedures",
      description:
        "The entity obtains or generates, uses and maintains relevant, quality information",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    // CC6: Logical & Physical Access (8)
    {
      ...
      description:
        "Restrict logical and physical access to systems and data to authorized users",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Entity restricts physical access to facilities to authorized personnel",
      automatable: false,
    },
    {
      name: "CC6.3 - Logical Access Control",
      description:
        "Entity restricts logical access to system functions and data to authorized users",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Entity restricts access based on appropriate authorization and authentication procedures",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Entity monitors logical access to systems and data, detects unauthorized activity",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Entity reviews system access and user rights periodically",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Entity promptly removes or disables logical access when authority expires",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Entity responds to physical security incidents appropriately",
      automatable: false,
    },
    // CC7: System Operations (5)
    {
      ...
      description:
        "Entity implements systems to prevent or detect unauthorized transactions",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Entity ensures availability of information systems and underlying infrastructure",
      automatable: false,
    },
    {
      name: "CC7.3 - Backup and Recovery",
      description:
        "Entity protects information systems and related assets through backup and recovery procedures",
      automatable: false,
    },
    {
      name: "CC7.4 - Encryption and Key Management",
      description:
        "Entity uses encryption for data in transit and at rest, implements key management",
      automatable: true,
      evaluationKey: "apps_connected",
    },
    {
      ...
      description:
        "Entity maintains and supports system infrastructure to ensure continued operation",
      automatable: false,
    },
    // CC8: Change Management (1)
    {
      ...
      description:
        "Entity authorizes, designs, configures, implements, maintains, and monitors changes",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    // CC9: Risk Mitigation (2)
    {
      ...
      description:
        "Entity defines and implements business continuity and disaster recovery plans",
      automatable: false,
    },
    {
      name: "CC9.2 - Third-Party Risk Management",
      description:
        "Entity assesses and monitors risks from third-party service providers",
      automatable: true,
      evaluationKey: "apps_connected",
    },
  ],
  ISO27001: [
    // A.5: Information Security Policies (2)
    {
      ...
      description:
        "Set of information security policies to support organizational objectives and compliance",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Review and update information security policies at planned intervals",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    ...
    },
    {
      ...
      description:
        "Coordinate information security across the organization",
      automatable: false,
    },
    {
      name: "A.6.1.3 - Information Security Competence and Skills",
      description:
        "Ensure personnel have necessary competence and skills in information security",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Define incident management responsibilities and escalation procedures",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Conduct regular assessments of information security compliance",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Include information security requirements in third-party agreements",
      automatable: true,
      evaluationKey: "apps_connected",
    },
    {
      ...
      description:
        "Manage information security in the supply chain",
      automatable: true,
      evaluationKey: "apps_connected",
    },
    // A.7: HR Security (7)
    {
      ...
      description:
        "Ensure employees are vetted and trained in information security before access",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Information security responsibilities are documented in terms and conditions",
      automatable: false,
    },
    {
      name: "A.7.2.1 - Management Responsibilities",
      description:
        "Management is responsible for enforcing information security policies",
      automatable: false,
    },
    {
      name: "A.7.2.2 - Information Security Awareness",
      description:
        "All personnel receive information security awareness training",
      automatable: false,
    },
    {
      name: "A.7.2.3 - Disciplinary Process",
      description:
        "Formal disciplinary process for information security policy violations",
      automatable: false,
    },
    {
      name: "A.7.3.1 - Responsibilities After Employment",
      description:
        "After employment termination, information security responsibilities are managed",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    // A.8: Asset Management (8)
    {
      ...
      description:
        "Maintain an inventory of information assets with owners and classifications",
      automatable: true,
      evaluationKey: "apps_connected",
    },
    {
      ...
      description:
        "Assets are used in accordance with assigned use rights",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "All assets are returned or disposed of when employment ends",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Information is removed or overwritten from media before reuse",
      automatable: false,
    },
    {
      name: "A.8.2.1 - Classification Criteria",
      description:
        "Information is classified according to organizational criteria",
      automatable: false,
    },
    {
      name: "A.8.2.2 - Information Labeling",
      description:
        "Information assets are appropriately labeled and classified",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Information is handled in accordance with its classification",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Media is disposed of safely and securely when no longer needed",
      automatable: false,
    },
    // A.9: Access Control (15)
    {
      ...
      description:
        "Establish and implement policy for access control to systems and data",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Formal procedures for user registration and access rights provisioning",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Restrict and manage privileged access to systems and data",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
    ...
    },
    {
      ...
      description:
        "Remove or restrict access rights when no longer required",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Implement password management policies to ensure secure authentication",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Access to information processing facilities is restricted",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Access to systems through secure logon procedures is enforced",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Passwords meet strength requirements and are securely managed",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "System access and use is monitored and logged",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Access to program source code is restricted and controlled",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    // A.10: Cryptography (2)
    {
      ...
      description:
        "A policy on use, protection, and expiry of cryptographic controls",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Cryptography is used appropriately to protect information confidentiality and integrity",
      automatable: true,
      evaluationKey: "apps_connected",
    },
    // A.11: Physical Security (9)
    {
      ...
      description:
        "Physical perimeter controls prevent unauthorized access to facilities",
      automatable: false,
    },
    {
      name: "A.11.1.2 - Physical Entry",
      description:
        "Physical access to facilities is restricted to authorized personnel",
      automatable: false,
    },
    {
      name: "A.11.1.3 - Securing Offices and Facilities",
      description:
        "Offices and facilities containing information assets are secured",
      automatable: false,
    },
    {
      name: "A.11.1.4 - Monitoring Physical Access",
      description:
        "Physical access to facilities is monitored and logged",
      automatable: false,
    },
    {
      name: "A.11.1.5 - Power and Environmental Controls",
      description:
        "Power, water, air, and environmental controls are in place",
      automatable: false,
    },
    {
      name: "A.11.2.1 - Equipment Security",
      description:
        "Equipment is positioned and protected to minimize risks",
      automatable: false,
    },
    {
      name: "A.11.2.2 - Equipment Maintenance",
      description:
        "Equipment is maintained regularly to ensure continued operation",
      automatable: false,
    },
    {
      name: "A.11.2.3 - Secure Disposal of Equipment",
      description:
        "Equipment is securely disposed of when no longer needed",
      automatable: false,
    },
    {
      name: "A.11.2.9 - Cabling Security",
      description:
        "Power and telecommunications cabling is protected from interference",
      automatable: false,
    },
    // A.12: Operations Security (8)
    {
      ...
      description:
        "Manage changes to systems to minimize impact on information security",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
    ...
    },
    {
      ...
      description:
        "Monitor systems and information to detect anomalies and unauthorized activities",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Record user activities, access, and changes to systems",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "System clocks are synchronized across the organization",
      automatable: true,
      evaluationKey: "apps_connected",
    },
    {
      ...
      description:
        "Implement controls to prevent and detect malware",
      automatable: false,
    },
    {
    ...
    },
    {
      ...
      description:
        "Information security is built into software development lifecycle",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    // A.13: Communications Security (4)
    {
      ...
      description:
        "Networks and groups of information services are managed separately",
      automatable: false,
    },
    {
      name: "A.13.1.3 - Network Access Control",
      description:
        "Access to network services is controlled",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Information transfer procedures are controlled and secured",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Data in transit is protected using encryption or other security controls",
      automatable: true,
      evaluationKey: "apps_connected",
    },
    // A.14: System Acquisition (6)
    {
      ...
      description:
        "Information security requirements are specified for systems and services",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Development of systems follows secure development lifecycle practices",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Security testing is conducted before systems are deployed",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Formal acceptance procedures are in place for systems before deployment",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    // A.16: Incident Management (7)
    {
      ...
      description:
        "Incident response responsibilities and procedures are defined",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Incidents are reported promptly to appropriate parties",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Incidents are assessed and validated",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Incident response activities are executed to contain and recover from incidents",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Root causes of incidents are identified and eradicated",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
    ...
    },
    {
      ...
      description:
        "Evidence is preserved and handled appropriately during incident response",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    // A.18: Compliance (5)
    ...
    },
    {
      ...
      description:
        "Organization complies with all applicable security requirements",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Compliance with information security policies and standards is assessed",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Information security performance is independently reviewed",
      automatable: false,
    },
    {
  ...
  "NIST CSF": [
    // IDENTIFY (5)
    {
      ...
      description:
        "Organization understands and documents systems, assets, and data to support risk assessment",
      automatable: true,
      evaluationKey: "apps_connected",
    },
    {
      ...
      description:
        "Organization understands business context and its mission-critical activities",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Governance structures support management and risk management",
      automatable: false,
    },
    {
      name: "ID.RA - Risk Assessment",
      description:
        "Organization conducts risk assessments to understand likelihood and impact",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Organization establishes risk management strategy and approach",
      automatable: false,
    },
    // PROTECT (7)
    {
      ...
      description:
        "Access to assets and data is limited based on need-to-know principles",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Personnel are trained on information security policies and procedures",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Data is protected through appropriate controls and encryption",
      automatable: true,
      evaluationKey: "apps_connected",
    },
    {
      ...
      description:
        "Security controls are implemented for systems and data",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Systems are maintained through patching and upgrades",
      automatable: false,
    },
    {
      name: "PR.PT - Protective Technology",
      description:
        "Technical controls are implemented to protect systems and data",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Third-party risks are assessed and managed",
      automatable: true,
      evaluationKey: "apps_connected",
    },
    // DETECT (3)
    {
      ...
      description:
        "Organizational systems detect and respond to anomalies and events",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Systems and data are continuously monitored for anomalies and unauthorized activity",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Detection processes are defined, maintained, and reviewed",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    // RESPOND (4)
    {
      ...
      description:
        "Response plan is prepared and communicated",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Incident information is coordinated and communicated",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      name: "RS.AN - Analysis",
      description:
        "Incidents are analyzed to understand impact and determine response",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Activities are performed to prevent or stop incidents",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    // RECOVER (3)
    {
      ...
      description:
        "Recovery plan is prepared and reviewed",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Recovery activities are conducted and results are reviewed",
      automatable: false,
    },
    {
      name: "RC.CO - Communications",
      description:
        "Restoration activities and associated communications are coordinated",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
  ],
  HIPAA: [
    // Administrative Safeguards (7)
    {
      ...
      description:
        "Designate a security officer responsible for developing and maintaining information security policies",
      automatable: false,
    },
    {
      name: "164.308(a)(2) - Workforce Security",
      description:
        "Implement policies for managing workforce access to systems and data",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Manage access based on role in the organization",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
    ...
    },
    {
      ...
      description:
        "Establish procedures for investigating and responding to security incidents",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Establish contingency plans for disaster recovery and business continuity",
      automatable: false,
    },
    {
      name: "164.308(a)(8) - Evaluation",
      description:
        "Conduct periodic evaluations of information security effectiveness",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    // Physical Safeguards (3)
    {
      ...
      description:
        "Implement measures to control physical access to facilities",
      automatable: false,
    },
    {
      name: "164.310(b) - Workstation Use",
      description:
        "Define proper use of workstations and devices",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Implement controls for devices and media containing protected health information",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    ...
    },
    {
      ...
      description:
        "Implement audit controls to record system activity",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
      ...
      description:
        "Implement controls to ensure data integrity and prevent unauthorized modification",
      automatable: true,
      evaluationKey: "apps_connected",
    },
    {
      ...
      description:
        "Implement authentication procedures to verify user identity",
      automatable: true,
      evaluationKey: "directory_connected",
    },
    {
      ...
      description:
        "Implement controls to protect data in transit",
      automatable: true,
      evaluationKey: "apps_connected",
    },
  ],
  GDPR: [
    // Data Protection Principles & Processing (3)
    {
      ...
      description:
        "Personal data is processed lawfully, fairly, transparently, and for legitimate purposes",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
      ...
      description:
        "Processing is based on legal basis such as consent, contract, or legal obligation",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Special safeguards are applied when processing sensitive personal data",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    // Consent & Transparency (3)
    {
      name: "Art.7 - Consent",
      description:
        "Obtain and manage explicit, informed, and freely given consent",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Provide clear and transparent information about data processing",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    // Data Subject Rights (3)
    {
      ...
      description:
        "Enable data subjects to access their personal data upon request",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Enable data subjects to request erasure of their personal data",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    {
      ...
      description:
        "Enable data subjects to obtain and reuse their personal data",
      automatable: true,
      evaluationKey: "workflows_configured",
    },
    // Data Security & Privacy (3)
    {
      ...
      description:
        "Implement data protection measures in system design and processing",
      automatable: true,
      evaluationKey: "policies_generated",
    },
    {
    ...
    // Breach & Assessment (2)
    {
      ...
      description:
        "Notify authorities and data subjects of personal data breaches",
      automatable: true,
      evaluationKey: "incidents_configured",
    },
    {
