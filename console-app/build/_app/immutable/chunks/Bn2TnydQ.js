...
var se = a(
  ...
  _e = a([`xlink:href`, `xml:id`, `xlink:title`, `xml:space`, `xmlns:xlink`]),
  ve = o(/\{\{[\w\W]*|[\w\W]*\}\}/gm),
  ye = o(/<%[\w\W]*|[\w\W]*%>/gm),
  be = o(/\$\{[\w\W]*/gm),
  C = o(/^data-[\-\w.\u00B7-\uFFFF]+$/),
...
function Ae() {
  let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : De(),
    n = (e) => Ae(e);
  if (
    ((n.version = `3.3.3`),
    (n.removed = []),
    !t || !t.document || t.document.nodeType !== T.document || !t.Element)
  )
  ...
  let { document: r } = t,
    ...
    o = i.currentScript,
    {
      ...
      Element: oe,
      NodeFilter: b,
      NamedNodeMap: ve = t.NamedNodeMap || t.MozNamedAttrMap,
      HTMLFormElement: ye,
      DOMParser: be,
      trustedTypes: C,
    } = t,
  ...
  let D,
    ...
    k = ke();
  n.isSupported =
    typeof e == `function` && typeof E == `function` && Me && Me.createHTMLDocument !== void 0;
  let {
      MUSTACHE_EXPR: Le,
      ERB_EXPR: Re,
      TMPLIT_EXPR: ze,
    ...
    at = null,
    ot = y({}, [`audio`, `video`, `img`, `source`, `image`, `track`]),
    st = null,
    ct = y({}, [
      `alt`,
      `class`,
    ...
    ut = null,
    dt = y({}, [W, G, K], ne),
    ft = y({}, [`mi`, `mo`, `mn`, `ms`, `mtext`]),
    pt = y({}, [`annotation-xml`]),
    mt = y({}, [`title`, `style`, `font`, `a`, `script`]),
    J = null,
    ht = [`application/xhtml+xml`, `text/html`],
    Y = null,
    X = null,
    gt = r.createElement(`form`),
    _t = function (e) {
    ...
    vt = function () {
      ...
      if (!(X && X === e)) {
        if (
          ((!e || typeof e != `object`) && (e = {}),
          (e = x(e)),
          (J = ht.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? `text/html` : e.PARSER_MEDIA_TYPE),
          (Y = J === `application/xhtml+xml` ? ne : p),
          (A = h(e, `ALLOWED_TAGS`) ? y({}, e.ALLOWED_TAGS, Y) : Ke),
          (j = h(e, `ALLOWED_ATTR`) ? y({}, e.ALLOWED_ATTR, Y) : qe),
          (ut = h(e, `ALLOWED_NAMESPACES`) ? y({}, e.ALLOWED_NAMESPACES, ne) : dt),
          (st = h(e, `ADD_URI_SAFE_ATTR`) ? y(x(ct), e.ADD_URI_SAFE_ATTR, Y) : ct),
          (at = h(e, `ADD_DATA_URI_TAGS`) ? y(x(ot), e.ADD_DATA_URI_TAGS, Y) : ot),
          (U = h(e, `FORBID_CONTENTS`) ? y({}, e.FORBID_CONTENTS, Y) : it),
          (N = h(e, `FORBID_TAGS`) ? y({}, e.FORBID_TAGS, Y) : x({})),
          (Je = h(e, `FORBID_ATTR`) ? y({}, e.FORBID_ATTR, Y) : x({})),
          (H = h(e, `USE_PROFILES`) ? e.USE_PROFILES : !1),
          ...
          H &&
            ((A = y({}, pe)),
            (j = s(null)),
            H.html === !0 && (y(A, se), y(j, me)),
            H.svg === !0 && (y(A, ce), y(j, he), y(j, _e)),
            H.svgFilters === !0 && (y(A, le), y(j, he), y(j, _e)),
            H.mathMl === !0 && (y(A, de), y(j, ge), y(j, _e))),
          h(e, `ADD_TAGS`) || (P.tagCheck = null),
          h(e, `ADD_ATTR`) || (P.attributeCheck = null),
          e.ADD_TAGS &&
            (typeof e.ADD_TAGS == `function`
              ? (P.tagCheck = e.ADD_TAGS)
              : (A === Ke && (A = x(A)), y(A, e.ADD_TAGS, Y))),
          e.ADD_ATTR &&
            (typeof e.ADD_ATTR == `function`
              ? (P.attributeCheck = e.ADD_ATTR)
              : (j === qe && (j = x(j)), y(j, e.ADD_ATTR, Y))),
          e.ADD_URI_SAFE_ATTR && y(st, e.ADD_URI_SAFE_ATTR, Y),
          e.FORBID_CONTENTS && (U === it && (U = x(U)), y(U, e.FORBID_CONTENTS, Y)),
          e.ADD_FORBID_CONTENTS && (U === it && (U = x(U)), y(U, e.ADD_FORBID_CONTENTS, Y)),
          rt && (A[`#text`] = !0),
          L && y(A, [`html`, `head`, `body`]),
          ...
          : e.namespaceURI === W
            ? t.namespaceURI === K
              ...
              : t.namespaceURI === G
                ...
                : !!bt[n]
            : e.namespaceURI === K
              ? (t.namespaceURI === G && !pt[r]) || (t.namespaceURI === W && !ft[r])
                ? !1
                : !bt[n] && (mt[n] || !yt[n])
              : !!(J === `application/xhtml+xml` && ut[e.namespaceURI])
        : !1;
    },
    Z = function (e) {
    ...
    St = function (e) {
      ...
      return (
        ...
        q === K ? Fe.call(t, L ? `html` : `body`)[0] : L ? t.documentElement : a
      );
    },
    Ct = function (e) {
      return Ne.call(
  ...
  let Et = function (e) {
      ...
      let r = Y(e.nodeName);
      if (
        ($(k.uponSanitizeElement, e, { tagName: r, allowedTags: A }),
        (I &&
          e.hasChildNodes() &&
          !Tt(e.firstElementChild) &&
          g(/<[/\w!]/g, e.innerHTML) &&
          g(/<[/\w!]/g, e.textContent)) ||
          e.nodeType === T.progressingInstruction ||
          (I && e.nodeType === T.comment && g(/<[/\w]/g, e.data)))
      )
        return (Z(e), !0);
      if (!(P.tagCheck instanceof Function && P.tagCheck(r)) && (!A[r] || N[r])) {
        if (
          !N[r] &&
          Ot(r) &&
          ((M.tagNameCheck instanceof RegExp && g(M.tagNameCheck, r)) ||
      ...
      return (e instanceof oe && !xt(e)) ||
        ...
        : (F &&
            ...
            e.textContent !== t && (f(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
    ...
    kt = function (e) {
      ...
      for (; i--; ) {
        ...
        if (
          ...
          $(k.uponSanitizeAttribute, e, r),
          (d = r.attrValue),
          nt && (c === `id` || c === `name`) && (Q(a, e), (d = `user-content-` + d)),
          I &&
            g(
        ...
        if (D && typeof C == `object` && typeof C.getAttributeType == `function` && !o)
          switch (C.getAttributeType(f, c)) {
            case `TrustedHTML`:
              d = D.createHTML(d);
              break;
    ...
    At = function e(t) {
      ...
      for ($(k.beforeSanitizeShadowDOM, t, null); (n = r.nextNode()); )
        ($(k.uponSanitizeShadowNode, n, null),
          Et(n),
          kt(n),
    ...
    (n.sanitize = function (e) {
      ...
      if (($e || vt(t), (n.removed = []), typeof e == `string` && (V = !1), V)) {
        ...
        ((r = St(`<!---->`)),
          ...
          (a.nodeType === T.element && a.nodeName === `BODY`) || a.nodeName === `HTML`
            ? (r = a)
            : r.appendChild(a));
      else {
      ...
      return (
        L &&
          ...
          g(we, r.ownerDocument.doctype.name) &&
          (d =
            `<!DOCTYPE ` +
            r.ownerDocument.doctype.name +
            `>
