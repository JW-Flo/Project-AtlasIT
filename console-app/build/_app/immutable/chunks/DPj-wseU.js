import { E as e } from "./CjbcrE1v.js";
var t = (e, t) => {
  ...
  n = (e, t) => ({ classGroupId: e, validator: t }),
  r = (e = new Map(), t = null, n) => ({ nextPart: e, validators: t, classGroupId: n }),
  i = `-`,
  a = [],
  o = `arbitrary..`,
  s = (e) => {
  ...
  c = (e, t, n) => {
    ...
    let o = n.validators;
    if (o === null) return;
    let s = t === 0 ? e.join(i) : e.slice(t).join(i),
      l = o.length;
    for (let e = 0; e < l; e++) {
      let t = o[e];
  ...
  _ = (e) => `isThemeGetter` in e && e.isThemeGetter === !0,
  v = (e) => {
  ...
  C = (e) => {
    let { prefix: t, experimentalParseClassName: n } = e,
      r = (e) => {
        ...
        s.endsWith(y)
          ? ((c = s.slice(0, -1)), (l = !0))
          : s.startsWith(y) && ((c = s.slice(1)), (l = !0));
  ...
  te = (e) => ({ cache: v(e.cacheSize), parseClassName: C(e), sortModifiers: w(e), ...s(e) }),
  ne = /\s+/,
  T = (e, t) => {
    let {
        parseClassName: n,
  ...
  Ee = D(() => {
    let e = k(`color`),
      ...
      N = () => [e, G, H],
      ie = () => [...y(), ve, he, { position: [G, H] }],
      ae = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
      oe = () => [`auto`, `cover`, `contain`, ye, de, { size: [G, H] }],
      P = () => [se, K, U],
      z = () => [``, `none`, `full`, l, G, H],
      B = () => [``, I, K, U],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: [`auto`, `square`, F, H, G, h] }],
        container: [`container`],
        columns: [{ columns: [I, H, G, s] }],
        ...
        z: [{ z: [L, `auto`, G, H] }],
        basis: [{ basis: [F, `full`, `auto`, s, ...C()] }],
        "flex-direction": [{ flex: [`row`, `row-reverse`, `col`, `col-reverse`] }],
        "flex-wrap": [{ flex: [`nowrap`, `wrap`, `wrap-reverse`] }],
        flex: [{ flex: [I, F, `auto`, `initial`, `none`, H] }],
        grow: [{ grow: [``, I, G, H] }],
        shrink: [{ shrink: [``, I, G, H] }],
        order: [{ order: [L, `first`, `last`, `none`, G, H] }],
        ...
        tracking: [{ tracking: [i, G, H] }],
        "line-clamp": [{ "line-clamp": [I, `none`, G, fe] }],
        leading: [{ leading: [a, ...C()] }],
        "list-image": [{ "list-image": [`none`, G, H] }],
        "list-style-position": [{ list: [`inside`, `outside`] }],
        "list-style-type": [{ list: [`disc`, `decimal`, `none`, G, H] }],
        "text-alignment": [{ text: [`left`, `center`, `right`, `justify`, `start`, `end`] }],
        "placeholder-color": [{ placeholder: N() }],
        "text-color": [{ text: N() }],
        "text-decoration": [`underline`, `overline`, `line-through`, `no-underline`],
        "text-decoration-style": [{ decoration: [...V(), `wavy`] }],
        "text-decoration-thickness": [{ decoration: [I, `from-font`, `auto`, G, U] }],
        "text-decoration-color": [{ decoration: N() }],
        "underline-offset": [{ "underline-offset": [I, `auto`, G, H] }],
        ...
        "bg-image": [
          {
            bg: [
              `none`,
              {
                linear: [{ to: [`t`, `tr`, `r`, `br`, `b`, `bl`, `l`, `tl`] }, L, G, H],
                radial: [``, G, H],
                conic: [L, G, H],
              },
              be,
        ...
        "outline-offset": [{ "outline-offset": [I, G, H] }],
        "outline-w": [{ outline: [``, I, K, U] }],
        "outline-color": [{ outline: N() }],
        shadow: [{ shadow: [``, `none`, u, q, W] }],
        "shadow-color": [{ shadow: N() }],
        "inset-shadow": [{ "inset-shadow": [`none`, ee, q, W] }],
        ...
        "text-shadow": [{ "text-shadow": [`none`, d, q, W] }],
        "text-shadow-color": [{ "text-shadow": N() }],
        opacity: [{ opacity: [I, G, H] }],
        ...
        "mask-image": [{ mask: [`none`, G, H] }],
        filter: [{ filter: [``, `none`, G, H] }],
        blur: [{ blur: Y() }],
        brightness: [{ brightness: [I, G, H] }],
        contrast: [{ contrast: [I, G, H] }],
        "drop-shadow": [{ "drop-shadow": [``, `none`, f, q, W] }],
        "drop-shadow-color": [{ "drop-shadow": N() }],
        grayscale: [{ grayscale: [``, I, G, H] }],
        "hue-rotate": [{ "hue-rotate": [I, G, H] }],
        invert: [{ invert: [``, I, G, H] }],
        saturate: [{ saturate: [I, G, H] }],
        sepia: [{ sepia: [``, I, G, H] }],
        "backdrop-filter": [{ "backdrop-filter": [``, `none`, G, H] }],
        "backdrop-blur": [{ "backdrop-blur": Y() }],
        "backdrop-brightness": [{ "backdrop-brightness": [I, G, H] }],
        "backdrop-contrast": [{ "backdrop-contrast": [I, G, H] }],
        "backdrop-grayscale": [{ "backdrop-grayscale": [``, I, G, H] }],
        "backdrop-hue-rotate": [{ "backdrop-hue-rotate": [I, G, H] }],
        "backdrop-invert": [{ "backdrop-invert": [``, I, G, H] }],
        "backdrop-opacity": [{ "backdrop-opacity": [I, G, H] }],
        "backdrop-saturate": [{ "backdrop-saturate": [I, G, H] }],
        "backdrop-sepia": [{ "backdrop-sepia": [``, I, G, H] }],
        ...
        duration: [{ duration: [I, `initial`, G, H] }],
        ease: [{ ease: [`linear`, `initial`, g, G, H] }],
        delay: [{ delay: [I, G, H] }],
        animate: [{ animate: [`none`, _, G, H] }],
        backface: [{ backface: [`hidden`, `visible`] }],
        perspective: [{ perspective: [m, G, H] }],
        ...
        "skew-x": [{ "skew-x": Q() }],
        "skew-y": [{ "skew-y": Q() }],
        transform: [{ transform: [G, H, ``, `none`, `gpu`, `cpu`] }],
        ...
        "will-change": [{ "will-change": [`auto`, `scroll`, `contents`, `transform`, G, H] }],
        fill: [{ fill: [`none`, ...N()] }],
        "stroke-w": [{ stroke: [I, K, U, fe] }],
