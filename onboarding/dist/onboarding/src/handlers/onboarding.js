...
export async function handleOnboarding(request, env) {
  try {
    const body = await request.json(); // Typed JSON body
...
export async function generateOnboardingQuestions(industry, requirements = []) {
  const baseQuestions = [
    {
      id: "company_size",
