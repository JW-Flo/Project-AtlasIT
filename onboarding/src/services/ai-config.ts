import { TenantConfig, AIConfigRequest, Integration, Workflow, SecurityConfig } from '../types';
...
export class AIConfigService {
  ...
  private async enhanceWithAI(baseConfig: TenantConfig, requirements: string[]): Promise<TenantConfig> {
