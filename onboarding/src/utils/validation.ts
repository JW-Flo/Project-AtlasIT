import { z } from 'zod';
import { TenantConfig, ValidationResult } from '../types';
...
export async function validateTenantConfig(config: TenantConfig): Promise<ValidationResult> {
  try {
...
export function validateOnboardingRequest(body: any): ValidationResult {
