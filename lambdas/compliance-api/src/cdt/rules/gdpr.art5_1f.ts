...
export function evalGDPR_Art5_1f(ev: CdtEvent): {
  ...
  return bothControls
    ? {
        decision: "pass",
        rationale: ["Encryption at rest and access controls protect data integrity"],
        references: ["GDPR:Art.5(1)(f)"],
      }
    : {
        decision: "fail",
        rationale: ["Missing encryption at rest or access controls for personal data"],
        references: ["GDPR:Art.5(1)(f)"],
      };
}
